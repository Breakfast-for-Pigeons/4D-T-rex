...
def get_roar():
	...
	sound files and then return it and its file length to the main function.
	"""
...
def activate_T_rex(sound, sound_length):
	"""
	The activate_T_rex function has two parameters: sound and sound length.
	...
	one of the randomly selected roars and its length. This function will play the 
	...
	try:
		...
		logging.exception("ValueError: A bad value was specified for t_rex_motor. The value should be between -1 and 1.")
		print("\033[1;31;40mA value error was encountered. Check the log in the 'Files' folder for more information.\n")
		stop_the_program()
